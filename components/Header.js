      ...
      <div className="relative w-full h-full hidden md:block">
        ...
        <div className="absolute top-0 left-0 w-full h-full z-0">
          ...
          >
            ...
            {/* Top bar */}
            <path d="M0 968 C 644 965, 612 955, 583 938 H 749 C 696 890, 645 839, 589 793 C 542 761, 483 77, 429 771 L 0 77 L 0 738 C 592 747, 557 702, 659 810 L 100 92 H 89 C 805 947, 741 972, 677 967 Z" fill="black"/>
          </svg>
        </div>
