...
async function getRide(slug) {
  ...
  // Replace 'populate=*' with a specific request for both fields.
  // This is the most reliable way to ensure all data is fetched.
...
export default async function RideDetailPage({ params }) {
  ...
  // This logic is correct for the single 'Media' field.
  const bannerUrl = featured_image?.url || null;
    
  // This logic is correct for the 'Multiple Media' field.
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {galleryImages.map((image) => {
                // This will now work because the API is sending the full data.
